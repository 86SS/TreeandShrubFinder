...
public class MainActivity extends AppCompatActivity {
    ...
    Plant Ponderosa_Lemon = new Plant("Ponderosa Lemon");
    Plant Meyer_Lemon = new Plant("Meyer Lemon");
    Plant Autumn_Magic_Black_Chokeberry = new Plant("Autumn Magic Black Chokeberry");
    Plant Viking_Black_Chokeberry = new Plant("Viking Black Chokeberry");
    Plant Dwarf_Burning_Bush = new Plant("Dwarf Burning Bush");
    Plant Winters_Star_Camellia = new Plant("Winters Star Camellia");
    Plant April_Dawn_Camellia = new Plant("April Dawn Camellia");
    Plant Double_Knock_Out_Rose = new Plant("Double Knock Out Rose");
    Plant Autumn_Ivory_Encore_Azalea = new Plant("Autumn Ivory Encore Azalea");
    Plant Autumn_Sunset_Encore_Azalea = new Plant("Autumn Sunset Encore Azalea");
    Plant Baby_Gem_Boxwood = new Plant("Baby Gem Boxwood");
    Plant Hardy_Pecan = new Plant("Hardy Pecan");
    Plant Johns_Elderberry = new Plant("Johns Elderberry");
    Plant The_Rising_Sun_Redbud = new Plant("The Rising Sun Redbud");
    Plant Chinese_Pistachio = new Plant("Chinese Pistachio");
    Plant Japanese_Zelkova = new Plant("Japanese Zelkova");
    Plant Carpathian_English_Walnut = new Plant("Carpathian English Walnut");
    Plant Granny_Smith_Apple = new Plant("Granny Smith Apple");
    Plant Bartlett_Pear = new Plant("Bartlett Pear");
    Plant Dwarf_Asian_Pear = new Plant("Dwarf Asian Pear");
    Plant Dwarf_Twentieth_Century_Asian_Pear = new Plant("Dwarf Twentieth Century Asian Pear");
    Plant Gala_Apple = new Plant("Gala Apple");
    Plant Reliance_Peach = new Plant("Reliance Peach");
    Plant Stanley_Plum = new Plant("Stanley Plum");
    Plant Stella_Sweet_Cherry = new Plant("Stella Sweet Cherry");
    Plant Semi_Dwarf_Stella_Sweet_Cherry = new Plant("Semi Dwarf Stella Sweet Cherry");
    Plant Bing_Sweet_Cherry = new Plant("Bing Sweet Cherry");
    Plant Contender_Peach = new Plant("Contender Peach");
    Plant Fuyu_Persimmon = new Plant("Fuyu Persimmon");
    Plant Halls_Hardy_Almond = new Plant("Halls Hardy Almond");
    ...
    public void onResume(){
        ...
        test.add(Ponderosa_Lemon);
        test.add(Meyer_Lemon);
        test.add(Autumn_Magic_Black_Chokeberry);
        test.add(Viking_Black_Chokeberry);
        test.add(Dwarf_Burning_Bush);
        test.add(Winters_Star_Camellia);
        test.add(April_Dawn_Camellia);
        test.add(Double_Knock_Out_Rose);
        test.add(Autumn_Ivory_Encore_Azalea);
        test.add(Autumn_Sunset_Encore_Azalea);
        test.add(Baby_Gem_Boxwood);
        test.add(Hardy_Pecan);
        test.add(Johns_Elderberry);
        test.add(The_Rising_Sun_Redbud);
        test.add(Chinese_Pistachio);
        test.add(Japanese_Zelkova);
        test.add(Carpathian_English_Walnut);
        test.add(Granny_Smith_Apple);
        test.add(Bartlett_Pear);
        test.add(Dwarf_Asian_Pear);
        test.add(Dwarf_Twentieth_Century_Asian_Pear);
        test.add(Gala_Apple);
        test.add(Reliance_Peach);
        test.add(Stanley_Plum);
        test.add(Stella_Sweet_Cherry);
        test.add(Semi_Dwarf_Stella_Sweet_Cherry);
        test.add(Bing_Sweet_Cherry);
        test.add(Contender_Peach);
        test.add(Fuyu_Persimmon);
        test.add(Halls_Hardy_Almond);
